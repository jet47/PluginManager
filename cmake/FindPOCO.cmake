...
#
# This module defines
#  POCO_INCLUDE_DIRS, where to find Poco.h, etc.
...
if(POCO_INCLUDE_DIR)
    ...
    if(EXISTS ${_versionFile})
        ...
        string(REGEX REPLACE ".*#define POCO_VERSION[ \t]+0x([0-9A-Za-z]+).*" "\\1" _versionHex ${_versionContents})
...
endforeach()
list(APPEND _requestedComponents "Foundation")
list(REMOVE_DUPLICATES _requestedComponents)

# Find each library.
set(POCO_LIBRARIES)
foreach(lib ${_requestedComponents})
    find_library(POCO_${lib}_LIBRARY NAMES "Poco${lib}" PATHS "/usr/lib")
